      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
          <button
            ...
            style={catTabStyle(selectedParentId === null)}
          >
            전체
          </button>
          {categories.map(cat => (
            <button
              ...
              style={catTabStyle(selectedParentId === cat.id)}
            >
              {cat.name}
            </button>
          ))}
        ...
        {selectedParent && selectedParent.children?.length > 0 && (
          <div style={{
            ...
            marginTop: '0.75rem', paddingTop: '0.75rem', borderTop: '1px solid #f3f4f6',
          }}>
            <button
              onClick={() => handleSelectChild(null)}
              style={subCatTabStyle(selectedChildId === null)}
            >
              전체
            </button>
            {selectedParent.children.map(child => (
              <button
                ...
                style={subCatTabStyle(selectedChildId === child.id)}
              >
                {child.name}
              </button>
            ))}
